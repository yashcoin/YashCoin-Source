...
unsigned int nStakeMinAge = 8 * nOneHour; // 8 hr as zero time weight
unsigned int nStakeMaxAge = 4 * 24 * nOneHour; // 4 days as full weight
...
const string strMessageMagic = "YashCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("YashCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in YashCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // YashCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "YashCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "YASH Genesis";
        CTransaction txNew;
        ...
        block.nNonce   = 885578; // !fTestNet ? 1575379 : 46534;

        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0xc4fbcca241b1dc3ad170b6cf444f3cf40cd740d220a0d23e10a991d065468321"));
...
unsigned char pchMessageStart[4] = { 0xb6, 0xf5, 0xea, 0xef };
