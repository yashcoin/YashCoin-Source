...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("YASH");
    case mBTC: return QString("mYASH");
    case uBTC: return QString::fromUtf8("μYASH");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("YashCoins"));
    case mBTC: return QString(QObject::tr("Milli-YashCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-YashCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
